...
* Install two apps on the phone:
    ...
    > 2. [MQTT Dash APP](https://play.google.com/store/apps/details?id=net.routix.mqttdash&hl=en "https://play.google.com/store/apps/details?id=net.routix.mqttdash&hl=en") IoT(Use the ESP8266 with the MQTT protocol to send PMbus data to the cloud). <br/>
