...
* Modify "Wire.h", Wire.cpp", added the Wire.requestFromS to Support SMbus Wire.requestFrom. in folder %USERPROFILE%\AppData\Local\Arduino15\packages\esp8266\hardware\esp8266\3.0.1\libraries\Wire
 ### ESP-01S:  <br/>
