...
uint8_t TwoWire::requestFromS(uint8_t address, uint8_t *acceptBuffer, uint16_t quantity, uint8_t sendStop)
{
...
uint8_t TwoWire::requestFrom(int address, int quantity, int sendStop)
{
 ...
 // for SMbus requestFromS
uint8_t TwoWire::requestFrom(uint8_t address, uint8_t *acceptBuffer, uint16_t quantity)
{
  return requestFromS((uint8_t)address, (uint8_t *) acceptBuffer, (uint16_t)quantity, (uint8_t)true);
}
...
{
  return requestFromS((uint8_t)address, (uint8_t *) acceptBuffer, (uint16_t)quantity, (uint8_t)sendStop);
}
